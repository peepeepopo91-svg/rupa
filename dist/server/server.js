...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-CRBgKAXk.js");
...
const manifest = {
  "2bfeee87903e4e8c0006779de0f385348ee7c23394b757226d4e2949ff07d10f": {
    ...
    importer: () => import("./assets/publishServer-MK5NfKEp.js")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-DB9jBhvF.js").then((n) => n.O),
