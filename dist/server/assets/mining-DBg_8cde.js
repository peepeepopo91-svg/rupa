...
import { u as useMining, M as MiningProvider } from "./MiningContext-CxiEdpvC.js";
...
import { M as MiningToast } from "./MiningToast-C56cEATW.js";
import { g as getLeaderboard } from "./miningServer-Io_unqEH.js";
        ...
        /* @__PURE__ */ jsxs("div", { className: "pt-1", children: [
          ...
          showNewUser && /* @__PURE__ */ jsxs("div", { className: "mt-2 p-4 rounded-xl border border-[#5865F2]/20 bg-[#5865F2]/5 space-y-3", children: [
            /* @__PURE__ */ jsxs("p", { className: "text-gray-300 text-xs font-semibold flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsx("span", { children: "💬" }),
              " How to get your mining credentials"
            ] }),
            /* @__PURE__ */ jsxs("ol", { className: "space-y-1.5 text-gray-500 text-xs", children: [
              /* @__PURE__ */ jsxs("li", { className: "flex gap-2 leading-relaxed", children: [
                /* @__PURE__ */ jsx("span", { className: "text-[#5865F2] font-bold shrink-0 mt-px", children: "1." }),
                /* @__PURE__ */ jsx("span", { children: "Join the Blue Network Discord using the button below." })
              ] }),
              /* @__PURE__ */ jsxs("li", { className: "flex gap-2 leading-relaxed", children: [
                /* @__PURE__ */ jsx("span", { className: "text-[#5865F2] font-bold shrink-0 mt-px", children: "2." }),
                /* @__PURE__ */ jsxs("span", { children: [
                  "Head to the ",
                  /* @__PURE__ */ jsx("span", { className: "text-gray-300 font-semibold", children: "#mining" }),
                  " section of the server."
                ] })
              ] }),
              /* @__PURE__ */ jsxs("li", { className: "flex gap-2 leading-relaxed", children: [
                /* @__PURE__ */ jsx("span", { className: "text-[#5865F2] font-bold shrink-0 mt-px", children: "3." }),
                /* @__PURE__ */ jsxs("span", { children: [
                  "Open a ",
                  /* @__PURE__ */ jsx("span", { className: "text-gray-300 font-semibold", children: "request-credential" }),
                  " ticket — a staff member will create your account."
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxs(
