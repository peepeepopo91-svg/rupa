    ...
    <footer className="border-t border-white/5 bg-[#0B0F17] pt-16 pb-8 px-4">
      <div className="max-w-6xl mx-auto">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div>
                ...
                <span className="font-mono text-[#00BFFF] text-sm">{content.serverIP}</span>
              </div>
              <a
                href={content.discordLink}
                target="_blank"
        ...
        <div className="border-t border-white/5 pt-6 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-gray-700 text-xs">{content.footerCopyright}</p>
          <p className="text-gray-700 text-xs">{content.footerTagline}</p>
        </div>
      </div>
    </footer>
  )
